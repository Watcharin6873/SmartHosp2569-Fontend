  ...
  return (
    <div style={{ fontFamily: 'Sarabun, sans-serif' }}>
      <div className='d-flex justify-content-center mb-3'>
        <h4 className='text-success fw-bold'>อนุมัติการประเมินโรงพยาบาลอัจฉริยะ ด้านบริหารจัดการ (Management)</h4>
      </div>
...
export default FormApproveManagement