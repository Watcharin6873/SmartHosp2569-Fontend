    ...
    <>
      <div style={{ fontFamily: "Sarabun, sans-serif" }}>
        <div className='d-flex justify-content-center'>
          <h3 className='p-3'>แบบประเมินด้านบุคลากร (People)</h3>
        </div>
            ...
            <table className="table table-bordered">
              <thead>
                <tr className="table-success">
                  <th className="text-center align-middle">แบบประเมินด้านบุคลากร</th>
            ...
            <div className='modal-content shadow-lg border-0'>
              <div className='modal-header bg-success text-white'>
                <h5 className='modal-title' id='formUploadModalLabel'>
                  📋 แนบไฟล์หลักฐานด้านบริหารจัดการ (Management)
                </h5>
                <button
                  type='button'
...
export default FormEvaluateOfficer
