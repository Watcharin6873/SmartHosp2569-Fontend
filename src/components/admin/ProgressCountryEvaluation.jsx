...
const ProgressCountryEvaluation = ({ listHospitals, listHospitalsInEvaluate }) => {

    const filterInfra = listHospitalsInEvaluate.filter(f => f.category_id === 2);
    const filterManage = listHospitalsInEvaluate.filter(f => f.category_id === 3);
    const filterServ = listHospitalsInEvaluate.filter(f => f.category_id === 4);
    const filterPeople = listHospitalsInEvaluate.filter(f => f.category_id === 5);

    const maxValue = listHospitals.length || 1; // กันหาร 0
                ...
                <div className='p-3 border bg-light rounded-3 shadow h-100'>
                    ...
                    <div className="d-flex justify-content-center px-3">
                        ...
                        >
                            ...
                            <div
                                className='progress-bar progress-bar-striped progress-bar-animated text-secondary'
                                role='progressbar'
                                style={{
...
export default ProgressCountryEvaluation
