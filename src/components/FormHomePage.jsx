...
const FormHomePage = () => {
    ...
    // const resultFobar = [
    //     { zone: 1, ระดับเพชร: 3, ระดับทอง: 8, ระดับเงิน: 5, ไม่ผ่าน: 2 },
    //     { zone: 2, ระดับเพชร: 5, ระดับทอง: 6, ระดับเงิน: 4, ไม่ผ่าน: 1 },
    //     { zone: 3, ระดับเพชร: 2, ระดับทอง: 7, ระดับเงิน: 6, ไม่ผ่าน: 3 },
    //     { zone: 4, ระดับเพชร: 6, ระดับทอง: 9, ระดับเงิน: 3, ไม่ผ่าน: 1 },
    //     { zone: 5, ระดับเพชร: 1, ระดับทอง: 5, ระดับเงิน: 7, ไม่ผ่าน: 4 },
    //     { zone: 6, ระดับเพชร: 4, ระดับทอง: 8, ระดับเงิน: 4, ไม่ผ่าน: 2 },
    //     { zone: 7, ระดับเพชร: 7, ระดับทอง: 6, ระดับเงิน: 2, ไม่ผ่าน: 1 },
    //     { zone: 8, ระดับเพชร: 3, ระดับทอง: 4, ระดับเงิน: 6, ไม่ผ่าน: 5 },
    //     { zone: 9, ระดับเพชร: 5, ระดับทอง: 7, ระดับเงิน: 3, ไม่ผ่าน: 2 },
    //     { zone: 10, ระดับเพชร: 2, ระดับทอง: 6, ระดับเงิน: 5, ไม่ผ่าน: 3 },
    //     { zone: 11, ระดับเพชร: 6, ระดับทอง: 5, ระดับเงิน: 3, ไม่ผ่าน: 1 },
    //     { zone: 12, ระดับเพชร: 4, ระดับทอง: 9, ระดับเงิน: 2, ไม่ผ่าน: 1 }
    // ];
